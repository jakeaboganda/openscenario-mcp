...
4. **Gather Evidence in Multi-Component Systems**
   ...
   Run once to gather evidence showing WHERE it breaks, THEN analyze to find the failing component.
...
2. **Compare Against References** — read reference implementation COMPLETELY, every line
3. **Identify Differences** — list every difference between working and broken, however small
4. **Understand Dependencies** — what config, environment, assumptions does this need?
...
4. **If Fix Doesn't Work** — STOP. Count attempts.
   ...
   - **If ≥ 3: Question the architecture (Step 5)**
