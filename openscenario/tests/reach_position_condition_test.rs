...
fn test_reach_position_condition_different_position_types() {
    ...
    let result1 = scenario.add_event_with_reach_position_condition(
        "main_story", "act1", "mg1", "maneuver1", "event_world",
        "ego", world_pos, 2.0,
    );
    ...
    let result2 = scenario.add_event_with_reach_position_condition(
        "main_story", "act1", "mg1", "maneuver1", "event_lane",
        "ego", lane_pos, 2.0,
    );
    ...
    let result3 = scenario.add_event_with_reach_position_condition(
        "main_story", "act1", "mg1", "maneuver1", "event_road",
        "ego", road_pos, 2.0,
    );
...
fn test_reach_position_condition_multiple_conditions() {
    ...
    scenario.add_event_with_reach_position_condition(
        "main_story", "act1", "mg1", "maneuver1", "checkpoint1",
        "ego", pos1, 1.0,
    ).unwrap();
    
    let pos2 = Position::world(100.0, 0.0, 0.0, 0.0);
    scenario.add_event_with_reach_position_condition(
        "main_story", "act1", "mg1", "maneuver1", "checkpoint2",
        "ego", pos2, 1.0,
    ).unwrap();
    
    let pos3 = Position::world(150.0, 0.0, 0.0, 0.0);
    scenario.add_event_with_reach_position_condition(
        "main_story", "act1", "mg1", "maneuver1", "checkpoint3",
        "ego", pos3, 1.0,
    ).unwrap();
