...
fn test_standstill_condition_xml_export() {
    ...
    scenario
        .add_event_with_standstill_condition(
            "main_story",
            "act1",
            "mg1",
            "maneuver1",
...
fn test_standstill_condition_multiple_vehicles() {
    ...
    scenario
        .add_vehicle("car1", vehicle_params.clone())
        .unwrap();
    scenario
        .add_vehicle("car2", vehicle_params.clone())
        .unwrap();
    scenario.add_vehicle("car3", vehicle_params).unwrap();
    scenario
        .set_initial_position("car1", Position::world(0.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("car2", Position::world(10.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("car3", Position::world(20.0, 0.0, 0.0, 0.0))
        .unwrap();
    ...
    scenario
        ...
        .unwrap();
    scenario
        .add_actor("main_story", "act1", "mg1", "car1")
        .unwrap();
    scenario
        .add_actor("main_story", "act1", "mg1", "car2")
        .unwrap();
    scenario
        .add_actor("main_story", "act1", "mg1", "car3")
        .unwrap();
    scenario
        .add_maneuver("main_story", "act1", "mg1", "maneuver1")
        .unwrap();
