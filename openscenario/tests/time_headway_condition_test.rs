...
fn test_time_headway_condition_basic() {
    ...
    scenario
        .add_vehicle("lead_vehicle", vehicle_params)
        .unwrap();
    scenario
        .set_initial_position("ego", Position::world(0.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("lead_vehicle", Position::world(30.0, 0.0, 0.0, 0.0))
        .unwrap();
...
fn test_time_headway_condition_close_following() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("lead_vehicle", Position::world(10.0, 0.0, 0.0, 0.0))
        .unwrap();
...
fn test_time_headway_condition_reference_point() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("lead_vehicle", Position::world(20.0, 0.0, 0.0, 0.0))
        .unwrap();
...
fn test_time_headway_condition_with_edge_and_delay() {
    ...
    let result = scenario.add_event_with_time_headway_condition_advanced(
        ...
        0.3, // trigger on rising edge with 0.3s delay
    );
...
fn test_time_headway_condition_xml_export() {
    ...
    scenario
        .add_event_with_time_headway_condition(
            "main_story",
            "act1",
            "mg1",
            "maneuver1",
...
fn test_time_headway_condition_platooning_scenario() {
    ...
    scenario
        .add_vehicle("lead", vehicle_params.clone())
        .unwrap();
    scenario
        .add_vehicle("follower1", vehicle_params.clone())
        .unwrap();
    scenario.add_vehicle("follower2", vehicle_params).unwrap();
    scenario
        .set_initial_position("lead", Position::world(100.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("follower1", Position::world(80.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("follower2", Position::world(60.0, 0.0, 0.0, 0.0))
        .unwrap();
    ...
    scenario
        ...
        .unwrap();
    scenario
        .add_actor("main_story", "act1", "mg1", "follower1")
        .unwrap();
    scenario
        .add_actor("main_story", "act1", "mg1", "follower2")
        .unwrap();
    scenario
        .add_maneuver("main_story", "act1", "mg1", "maneuver1")
        .unwrap();
