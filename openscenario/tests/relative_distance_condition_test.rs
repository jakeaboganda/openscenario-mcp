...
fn test_relative_distance_condition_basic() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("target", Position::world(50.0, 0.0, 0.0, 0.0))
        .unwrap();
...
fn test_relative_distance_condition_xml_export() {
    ...
    scenario
        .add_event_with_relative_distance_condition(
            "main_story",
            "act1",
            "mg1",
            "maneuver1",
...
fn test_relative_distance_condition_multiple_targets() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("target1", Position::world(20.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("target2", Position::world(40.0, 0.0, 0.0, 0.0))
        .unwrap();
