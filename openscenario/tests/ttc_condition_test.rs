...
fn test_ttc_condition_basic() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("target", Position::world(100.0, 0.0, 0.0, 0.0))
        .unwrap();
...
fn test_ttc_condition_multiple_targets() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("target1", Position::world(50.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("target2", Position::world(100.0, 0.0, 0.0, 0.0))
        .unwrap();
