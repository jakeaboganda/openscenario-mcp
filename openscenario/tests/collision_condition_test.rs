...
fn test_collision_condition_basic() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("target", Position::world(5.0, 0.0, 0.0, 0.0))
        .unwrap();
...
fn test_collision_condition_nonexistent_source_entity_fails() {
    ...
    scenario
        ...
        .unwrap();
    scenario
        .add_actor("main_story", "act1", "mg1", "target")
        .unwrap();
    scenario
        .add_maneuver("main_story", "act1", "mg1", "maneuver1")
        .unwrap();
...
fn test_collision_condition_xml_export() {
    ...
    scenario
        .add_event_with_collision_condition(
            "main_story",
            "act1",
            "mg1",
            "maneuver1",
...
fn test_collision_condition_multiple_targets() {
    ...
    scenario.add_vehicle("ego", vehicle_params.clone()).unwrap();
    scenario
        .add_vehicle("target1", vehicle_params.clone())
        .unwrap();
    ...
    scenario
        ...
        .unwrap();
    scenario
        .set_initial_position("target1", Position::world(5.0, 0.0, 0.0, 0.0))
        .unwrap();
    scenario
        .set_initial_position("target2", Position::world(10.0, 0.0, 0.0, 0.0))
        .unwrap();
